...
// Id réservé du Sankey maître (miroir de `default_main_sankey_id` d'OpenSankey/Utils).
// Redéclaré en local pour que ce module reste PUR (aucun import runtime de la couche OS,
// qui tire d3/chakra) et donc testable en isolation. C'est un id RÉSERVÉ et persisté
// (présent tel quel dans tous les fichiers) : sa valeur est figée.
