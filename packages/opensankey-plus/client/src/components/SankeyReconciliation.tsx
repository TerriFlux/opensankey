...
// import {
//   Alert, AlertIcon, Box, Button, Collapse, Divider, Input, Modal,
...
// import { actions_type, default_actions_type } from '../deps/OpenSankey/Modules'
// import { retrieveJSONResults } from '../deps/OpenSankey/components/dialogs/ExcelModalLoader'
...
//     // Fetching results
//     const path = window.location.origin
//     const url_optimize_retrieves_results = path + '/opensankey/upload/retrieve_result'
...
//         retrieveJSONResults(application_data_mfa, text,false)
//       }
//     } catch (error) {
...
//       const path = window.location.origin
//       const url_optimize_prod_process = path + '/opensankey/upload/check_process'
//       const fetchData = {
//         method: 'POST',
//         body: ''
//       }
...
//                     const path = window.location.origin
//                     const url_optimize_display_results = path + '/upload/retrieve_result'
//                     const form_data = new FormData()
//                     const fetchData = {
//                       method: 'POST',
//                       body: form_data
...
//     let launch_path = '/optimize/launch_optim'
//     if (menu_configuration_osp.action_type === 'optim_sankey') {
//       launch_path = '/optimize/launch_optim_sankey'
