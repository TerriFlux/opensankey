import { updateUnitaryStyles } from 'open-sankey/src/Algorithms/UnitaryBoard'
import { elementStyleConfigs, node_exchanges_style, node_unitary_styles } from 'open-sankey/src/Elements/ElementStyle'
import { Class_NodeElement } from 'open-sankey/src/Elements/Node'
import { compressJSONToGzip } from 'open-sankey/src/Persistence/UniversalJSONCompression'
import { Class_Tag } from 'open-sankey/src/types/Tag'
import { Class_ViewTagGroup } from 'open-sankey/src/types/TagGroup'
import { makeId } from 'open-sankey/src/types/Utils'
