...
const viewsAccordion = (data, set_data, show_menu, nav_item_active, set_nav_item_active, view, set_view, multi_selected_nodes, multi_selected_links, multi_selected_label) => {
  return react_1.default.createElement(react_bootstrap_1.Accordion.Item, { id: 'Visualisation', eventKey: 'Visualisation', style: { 'display': show_menu ? 'block' : 'none' }, onClick: evt => {
