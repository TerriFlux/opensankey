...
def create_app():
    ...
    from .views import flowapp as main_blueprint
    app.register_blueprint(main_blueprint)

   # AFM API
    from sankeytools.server.views import sankeytools
    from sankeytools.server.views import converter_funct
    from sankeytools.server.converter import extract_json_from_sankey
    from sankeytools.server.converter import extract_sankey_from_json
    ...
    app.register_blueprint(sankeytools)
