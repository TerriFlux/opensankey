...
export type MenuDraggableFType = (
  dict_hook_ref_setter_show_dialog_components : dict_hook_ref_setter_show_dialog_componentsType,
  dialog_name: 'ref_setter_show_menu_node_apparence' | 'ref_setter_show_menu_node_io'| 'ref_setter_show_menu_node_tooltip' | 'ref_setter_show_menu_link_data' | 'ref_setter_show_menu_link_appearence' | 
