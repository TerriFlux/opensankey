...
const SankeyLinkEdition: FunctionComponent<SankeyLinkEditionTypes> = (
  ...
  const source_change = (changeEvent: React.ChangeEvent<HTMLSelectElement>) => {
    let link = display_links[selected_link]
    if (duplicate) {
  ...
  const the_link = display_links[selected_link]
                  ...
                  <Row>
                    ...
                    <Col>
                      <Form.Select onChange={source_change}>
                        {display_nodes.map((n, i) => <option key={i} value={n.name} selected={selected_links[0].source_name === n.name} >{n.name}</option>)}
                      </Form.Select>
                    </Col>
                  </Row>
                  <br></br>
                  <Row>
                    ...
                    <Col>
                      <Form.Select onChange={target_change}>
                        {display_nodes.map((n, i) => <option key={i} value={n.name} selected={selected_links[0].target_name === n.name} >{n.name}</option>)}
                      </Form.Select>
                    </Col>
                  </Row>
                  <br></br>
                  <Row>
                    ...
                    <Col>
                      <Form.Control
                        ...
                        onChange={
                          (evt) => {
                            display_links[selected_link].value[value_index] = +evt.target.value
                            set_data({ ...data })
                          }
                        }
                      />
                  ...
                  <Row >
                    ...
                    <Col>
                      <Form.Control
                        ...
                        onChange={
                          (evt) => {
                            display_links[selected_link].display_value[value_index] = evt.target.value
                            set_data({ ...data })
                          }
                        }
                      />
