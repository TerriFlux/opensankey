...
export const SankeyApp = ({initial_sankey_data,exemple_menu,formations_menu,logo} : SankeyAppTypes) => {
  ...
  const vertical_dilation : React.RefObject<HTMLInputElement> = useRef() as React.RefObject<HTMLInputElement>
  const horizontal_dilation : React.RefObject<HTMLInputElement> = useRef() as React.RefObject<HTMLInputElement>
  ...
  const menu_banner=OpenSankeyMenuBanner(
    ...
    toolbar_builder(  t,data,set_data,mode_selection,user_scale,set_user_scale,filter,func_current_filter,detail_level,'',set_show_readme)
  )
