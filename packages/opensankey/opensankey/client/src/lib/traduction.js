    ...
    translation: {
      ...
      Noeud:{
        ...
        apparence:{
          ...
          'Couleur':'Color',
          'CouleurPérenne':'Sustainable Color',
          'Forme':'Shape',
          'Cercle':'Circle',
          'Rectangle':'Rectangle',
          'TML':'Width minimum',
  ...
  fr: {
    translation: {
      Menu:{
        ...
        'dns':'N\'affiche que les nœuds visibles dans le sélecteur de nœuds',
        'dls':'N\'affiche que les flux visibles dans le sélecteur de flux',

        'textDisposition':'Appliquer les modifications sur :',
        'PosNoeud':'Position Nœuds',
        'attrNode':'Attributs Nœuds',
        'attrFlux':'Attributs Flux',
        'tagNode':'Etiquette Nœuds',
      ...
      Noeud:{
        ...
        apparence:{
          ...
          'Couleur':'Couleur',
          'CouleurPérenne':'Couleur Pérenne',
          'Forme':'Forme',
          'Cercle':'Cercle',
          'Rectangle':'Rectangle',
          'TML':'Taille minimum Largeur',
          'TMH':'Taille minimum Hauteur',
          'HideAlone':'Masquer les nœuds intermédiaires',

          'asn':'Appliquer le style aux nœuds',
          'toScale':'Nœud non à l\'échelle',
          'Orientation':'Orientation : ',
      ...
      Banner:{
        ...
        'tooltipSelection':'Permet de drag les nœuds',
        'tooltipHelp':'Info supplementaires sur le diagramme',
        'tooltipAjoutNode':'Ajoute un nœud au click de la souris',
        'tooltipLiason':'Clicker puis relacher entre deux nœuds existant pour les liés avec un flux',
      }
