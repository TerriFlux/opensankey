    ...
    translation: {
      inspector: {
        ...
        unitary_process: {
          ...
          add_selected_tooltip: 'One port per selected node; the direction is deduced from the visible flows with the central process.',
          prefill: 'Prefill from the diagram',
          prefill_tooltip: 'Read the star of the central node: ports, directions and exchange coefficients. Port typing already entered is kept.',
          ...
          selected_is_port: 'The selected node is a port: {{direction}}, type {{port_type}}.',
    ...
    translation: {
      inspector: {
        ...
        unitary_process: {
          ...
          add_selected_tooltip: 'Un port par nœud sélectionné ; le sens est déduit des flux visibles avec le procédé central.',
          prefill: 'Pré-remplir depuis le diagramme',
          prefill_tooltip: 'Lit l\'étoile du nœud central : ports, sens et coefficients d\'échange. Le typage déjà saisi est conservé.',
          ...
          selected_is_port: 'Le nœud sélectionné est un port : {{direction}}, type {{port_type}}.',
    ...
    translation: {
      inspector: {
        ...
        unitary_process: {
          ...
          add_selected_tooltip: 'Un puerto por nodo seleccionado; el sentido se deduce de los flujos visibles con el proceso central.',
          prefill: 'Rellenar desde el diagrama',
          prefill_tooltip: 'Lee la estrella del nodo central: puertos, sentidos y coeficientes de intercambio. Se conserva el tipado ya introducido.',
          ...
          selected_is_port: 'El nodo seleccionado es un puerto: {{direction}}, tipo {{port_type}}.',
    ...
    translation: {
      inspector: {
        ...
        unitary_process: {
          ...
          add_selected_tooltip: 'Ein Port je ausgewähltem Knoten; die Richtung wird aus den sichtbaren Flüssen zum zentralen Prozess abgeleitet.',
          prefill: 'Aus dem Diagramm vorbelegen',
          prefill_tooltip: 'Liest den Stern des zentralen Knotens: Ports, Richtungen und Austauschkoeffizienten. Bereits erfasste Typisierung bleibt erhalten.',
          ...
          selected_is_port: 'Der ausgewählte Knoten ist ein Port: {{direction}}, Typ {{port_type}}.',
    ...
    translation: {
      inspector: {
        ...
        unitary_process: {
          ...
          add_selected_tooltip: 'Una porta per nodo selezionato; il verso è dedotto dai flussi visibili con il processo centrale.',
          prefill: 'Precompilare dal diagramma',
          prefill_tooltip: 'Legge la stella del nodo centrale: porte, versi e coefficienti di scambio. La tipizzazione già inserita è conservata.',
          ...
          selected_is_port: 'Il nodo selezionato è una porta: {{direction}}, tipo {{port_type}}.',
    ...
    translation: {
      inspector: {
        ...
        unitary_process: {
          ...
          add_selected_tooltip: '每个所选节点一个端口；方向由其与中心工艺之间的可见流推断。',
          prefill: '从图中预填',
          prefill_tooltip: '读取中心节点的星形结构：端口、方向和交换系数。已填写的端口类型将保留。',
          unknown_node: '未知节点',
          summary_central: '中心工艺：{{node}}',
          summary_ports: '已声明端口：{{n}}',
          summary_activity: '参考活动量：{{value}} {{unit}}',
          selected_is_central: '所选节点是本构件的中心工艺。',
          selected_is_port: '所选节点是一个端口：{{direction}}，类型 {{port_type}}。',
          port_untyped: '未定类型',
          edit_brick: '编辑构件'
        }
      },
    ...
    translation: {
      inspector: {
        ...
        unitary_process: {
          ...
          add_selected_tooltip: '選択ノードごとに一つのポートを作ります。向きは中心プロセスとの可視フローから推定されます。',
          prefill: '図から事前入力',
          prefill_tooltip: '中心ノードのスターを読み取り、ポート、向き、交換係数を取り込みます。入力済みの型付けは保持されます。',
          unknown_node: '不明なノード',
          ...
          selected_is_port: '選択中のノードはポートです：{{direction}}、型 {{port_type}}。',
          port_untyped: '型なし',
          edit_brick: 'ブリックを編集'
        }
      },
