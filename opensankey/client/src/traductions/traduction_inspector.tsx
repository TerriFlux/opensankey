    ...
    translation: {
      inspector: {
        ...
        determination: {
          ...
          show_flux: 'show the flows',
          hide_flux: 'hide the flows',
          zero_flux: '{{n}} other flow(s) at 0',
          ...
          meaning: {
            ...
            free: 'The constraints are not enough to fix this value; reconciliation picked one within the possible range. Constraining it requires entering it, or adding a constraint on one of the flows below.',
    ...
    translation: {
      inspector: {
        ...
        determination: {
          ...
          show_flux: 'voir les flux',
          hide_flux: 'masquer les flux',
          zero_flux: '{{n}} autre(s) flux à 0',
          ...
          meaning: {
            ...
            free: 'Les contraintes ne suffisent pas à fixer cette valeur ; la réconciliation en a choisi une dans l\'intervalle possible. Pour la contraindre, il faut la saisir ou ajouter une contrainte sur l\'un des flux ci-dessous.',
    ...
    translation: {
      inspector: {
        ...
        determination: {
          ...
          show_flux: 'ver los flujos',
          hide_flux: 'ocultar los flujos',
          zero_flux: '{{n}} otro(s) flujo(s) a 0',
          ...
          meaning: {
            ...
            free: 'Las restricciones no bastan para fijar este valor; la reconciliación eligió uno dentro del intervalo posible. Para restringirlo hay que introducirlo o añadir una restricción sobre uno de los flujos siguientes.',
    ...
    translation: {
      inspector: {
        ...
        determination: {
          ...
          show_flux: 'Flüsse anzeigen',
          hide_flux: 'Flüsse ausblenden',
          zero_flux: '{{n}} weitere(r) Fluss/Flüsse mit 0',
          ...
          meaning: {
            ...
            free: 'Die Nebenbedingungen genügen nicht, um diesen Wert festzulegen; der Abgleich hat einen aus dem möglichen Bereich gewählt. Um ihn zu binden, muss er eingegeben oder eine Nebenbedingung auf einem der folgenden Flüsse ergänzt werden.',
    ...
    translation: {
      inspector: {
        ...
        determination: {
          ...
          show_flux: 'mostra i flussi',
          hide_flux: 'nascondi i flussi',
          zero_flux: '{{n}} altro/i flusso/i a 0',
          ...
          meaning: {
            ...
            free: 'I vincoli non bastano a fissare questo valore; la riconciliazione ne ha scelto uno nell\'intervallo possibile. Per vincolarlo occorre inserirlo o aggiungere un vincolo su uno dei flussi seguenti.',
      ...
      inspector: {
        ...
        determination: {
          ...
          meaning: {
            ...
            free: '约束不足以确定该数值；调和在可能区间内选取了一个。若要约束它，需要录入该值，或在下列某条流上添加约束。',
      ...
      inspector: {
        ...
        determination: {
          ...
          meaning: {
            ...
            free: '制約だけではこの値は決まりません。調整は取りうる区間の中から一つを選びました。値を絞るには、この値を入力するか、下記のいずれかのフローに制約を加える必要があります。',
