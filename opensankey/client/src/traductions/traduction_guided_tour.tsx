  ...
  en: {
    translation: {
      guide: {
        ...
        drawing_area: 'The drawing area. This is where your diagram lives. To draw a flow: click, drag without releasing, then release — two nodes and the flow connecting them appear.',
  ...
  fr: {
    translation: {
      guide: {
        ...
        drawing_area: 'La zone de dessin. C\'est ici que vit votre diagramme. Pour tracer un flux : cliquez, faites glisser sans relâcher, puis relâchez — deux nœuds et le flux qui les relie apparaissent.',
  ...
  es: {
    translation: {
      guide: {
        ...
        drawing_area: 'El área de dibujo. Aquí es donde vive su diagrama. Para trazar un flujo: haga clic, arrastre sin soltar y luego suelte — aparecen dos nodos y el flujo que los une.',
  ...
  de: {
    translation: {
      guide: {
        ...
        drawing_area: 'Die Zeichenfläche. Hier lebt Ihr Diagramm. Um einen Fluss zu zeichnen: klicken, ohne loszulassen ziehen, dann loslassen — zwei Knoten und der Fluss dazwischen erscheinen.',
  ...
  it: {
    translation: {
      guide: {
        ...
        drawing_area: 'L\'area di disegno. È qui che vive il vostro diagramma. Per tracciare un flusso: cliccate, trascinate senza rilasciare, poi rilasciate — compaiono due nodi e il flusso che li collega.',
  ...
  'zh-CN': {
    translation: {
      guide: {
        ...
        drawing_area: '绘图区。您的图表就在这里。绘制流量的方法：点击、按住拖动，然后松开——两个节点及连接它们的流量便会出现。',
  ...
  ja: {
    translation: {
      guide: {
        ...
        drawing_area: '描画エリアです。ここに図を描いていきます。フローの描き方：クリックし、押したままドラッグして、離す — 2 つのノードとそれをつなぐフローが現れます。',
