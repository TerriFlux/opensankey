  ...
  en: {
    translation: {
      Menu: {
        ...
        rcc_osp_ctrl_czdt_bold: 'CTRL+Click (Text Box) / CMD+Click on Mac',
        ...
        rcc_ctrl_scrll_bold: 'CTRL+scroll / CMD+scroll on Mac (sankey draw zone)',
        rcc_ctrl_scrll: 'Zoom/Unzoom in the sankey zone',
        rcc_ctrl_z_bold: 'CTRL+Z / CMD+Z on Mac',
        rcc_ctrl_z: 'Cancel last modification done to the sankey',
  ...
  fr: {
    translation: {
      Menu: {
        ...
        rcc_shift_cn_bold: 'CTRL + dblClick (noeuds) / CMD + dblClick sur Mac',
        rcc_shift_cn: 'Sélectionne le noeud cliqué et ouvre l\'onglet "Noeuds" du menu',
        rcc_ctrl_cn_bold: 'CTRL + Click (noeuds) / CMD + Click sur Mac',
        ...
        rcc_shift_cf_bold: 'CTRL + dblClick (flux) / CMD + dblClick sur Mac',
        rcc_shift_cf: 'Sélectionne le flux cliqué et ouvre l\'onglet "Flux" du menu',
        rcc_ctrl_cf_bold: 'CTRL + Click (flux) / CMD + Click sur Mac',
        ...
        rcc_osp_cs: 'Crée une vue qui peut être ensuite modifiée, pour conserver les modifications appliquées à la vue il faut l\'enregistrer avec Ctrl+S (CMD+S sur Mac)',
        rcc_osp_ctrl_czdt_bold: 'CTRL+Click (Zone Texte) / CMD+Click sur Mac :',
        ...
        rcc_ctrl_scrll_bold: 'CTRL+scroll / CMD+scroll sur Mac (zone de dessin)',
        rcc_ctrl_scrll: 'Permet de zoomer/dézoomer sur la zone de dessin',
