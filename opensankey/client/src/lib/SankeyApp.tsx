...
export const SankeyApp = ({initial_sankey_data,exemple_menu,formations_menu,logo,logo_terriflux} : SankeyAppTypes) => {
  ...
  const dragLink_data=show_menu_link_data?MenuDraggable(menu_link_data,pointer_pos,t('Menu.flux')+' '+t('Flux.data.données'),showMenuComponents.show_menu_link_data[1]):<></>
