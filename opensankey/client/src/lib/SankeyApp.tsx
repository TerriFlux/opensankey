...
export const SankeyApp = ({initial_sankey_data,exemple_menu,formations_menu,logo} : SankeyAppTypes) => {
  ...
  let vertical_dilation : React.RefObject<HTMLInputElement> = useRef() as React.RefObject<HTMLInputElement>
  let horizontal_dilation : React.RefObject<HTMLInputElement> = useRef() as React.RefObject<HTMLInputElement>
