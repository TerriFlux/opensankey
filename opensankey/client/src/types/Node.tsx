...
export class Class_NodeElement extends Class_Element {
  ...
  private addLinkMoveOrderHandle(link: Class_LinkElement, input: boolean) {
    ...
    const handle = new Class_Handler(('handle_' + this.id + custom_id + '_' + link.id), this.drawing_area, this.menu_config, this, this.dragStartHandlerMoveLink, this.dragHandlerMoveLink, this.dragEndHandlerMoveLink)
