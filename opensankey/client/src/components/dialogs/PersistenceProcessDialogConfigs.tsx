...
type LocalizedLabel = { en: string; fr: string; es: string; de: string; it: string; 'zh-CN'?: string }
...
export interface FormatAttributeConfig<T> {
  ...
  disabledTooltip?: { en: string; fr: string; es?: string; de?: string; it?: string; 'zh-CN'?: string }
  group?: OptionGroup
  ...
  selectOptions?: { value: string; labels: { en: string; fr: string; es?: string; de?: string; it?: string; 'zh-CN'?: string } }[]
}
