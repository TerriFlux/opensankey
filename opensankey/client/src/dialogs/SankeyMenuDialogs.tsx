            ...
            <Checkbox
              ...
              onChange={(evt) => {
                ...
                if (evt.target.checked) {
                  ...
                  ComputeParametrization(applicationData,true)
                } else {
                  Object.values(data.style_node)
                    .filter(style=>style.idNode !== 'NodeExportStyle' && style.idNode !== 'NodeImportStyle')
 ...
 *
 * @param {{ UploadExcelImpl: any; handleCloseDialog: any; set_data: any; data: any; set_show_excel_dialog: any; url_prefix: any; launch: any; }} { UploadExcelImpl, handleCloseDialog, set_data, data, set_show_excel_dialog,url_prefix,launch }
 * @returns
 */
