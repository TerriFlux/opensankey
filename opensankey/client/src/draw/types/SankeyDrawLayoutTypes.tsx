...
import { SankeyData, SankeyLink, SankeyNode, agregationType } from '../../types/Types'

export type ComputeAutoSankeyFuncType = (data: SankeyData, h_space: number,reset_scale:boolean) => void
